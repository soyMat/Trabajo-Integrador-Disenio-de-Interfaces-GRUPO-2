...
const productosIniciales = [
  { id: 1, name: 'Dulce de Calafate (200g)', category: 'Mermeladas y Dulces', price: 1200, stock: 45, status: 'Activo', description: 'Exquisito dulce patagonico, ideal para desayunos.', imageUrl: 'https://imgs.search.brave.com/4uQg8dWLnPgaX0L9Q1Cdyw_2VJ_yr5yX3DSgA-Y2OjE/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly91cy4x/MjNyZi5jb20vNDUw/d20vbmljaGFwaGlt/L25pY2hhcGhpbTE3/MDkvbmljaGFwaGlt/MTcwOTAwMDIyLzg1/NTYxNTY5LW1hbnph/bmEtcm9qYS1zb2Jy/ZS11bi1mb25kby1i/bGFuY28uanBnP3Zl/cj02' },
  { id: 2, name: 'Ahumado de Centolla', category: 'Pescados y Mariscos', price: 3500, stock: 0, status: 'Sin Stock', description: 'Centolla fueguina ahumada con madera de lenga.', imageUrl: 'https://imgs.search.brave.com/ZrDjQjStv9RS0eAdwiYzoVPywCucRwaWDdxGkoyi1ek/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/bm92b2dhci5jb20u/YXIvSW1hZ2UvMC8y/NzBfMjcwLUNBODEz/M05fMS53ZWJw' },
  { id: 3, name: 'Cerveza Artesanal Beagle (Rubia)', category: 'Bebidas', price: 800, stock: 80, status: 'Activo', description: 'Cerveza clasica de Ushuaia, sabor suave.', imageUrl: 'https://imgs.search.brave.com/2gbQL7Da0vul-fDLzbdolxzoegZZbnDmzYCJ4FXnlN4/rs:fit:860:0:0:0/g:' },
